...
\begin{ejercicio}{9}
    Dada \( x \) una red en \( X \):
    \begin{enumerate}
        \item Si \( Y \subseteq Z \subseteq X \) y \( x \) es universal en \( Y \) entonces es universal en \( Z \).
        \item Si \( x \) es universal en \( X \) entonces toda subred de \( x \) también es universal en \( X \).
    \end{enumerate}
\end{ejercicio}
\begin{proof}
