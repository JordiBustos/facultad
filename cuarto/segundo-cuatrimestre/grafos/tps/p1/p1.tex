...
\begin{proof}
    ...
    Para ver que \( G_4 \) es isomorfo a \( G_3 \) y no lo es ni a \( G_1 \) ni a \( G_2 \) notemos que podemos permutar de la siguiente forma:\[
        a \mapsto c, \,
        b \mapsto b, \,
        c \mapsto a, \,
        d \mapsto g, \,
    ...
    \begin{center}
        ...
        \end{tikzpicture}
    \end{center}
    Nos basta con notar que ambos complementos se pueden llevar al mismo ciclo de 7 vértices, lo que demuestra que \( \overline{G_1} \) es isomorfo a \( \overline{G_5} \) y, por el \emph{Ejercicio 8}, se concluye que \( G_1 \) es isomorfo a \( G_5 \).
\end{proof}
